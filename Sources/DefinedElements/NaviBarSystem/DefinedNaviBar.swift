...
struct DefinedNaviBar<Content> : View, DefinedView where Content : View {
    typealias Page = DefinedNaviPage
    ...
    public init(front: Binding<Page?>? = nil,
                start: Int = 0,
...
struct DefinedNaviItem : View {
    ...
    init(_ itemImage: (String, String)? = nil,
    ...
    init<Content>(action: @escaping () -> Void = {},
                  page: DefinedNaviPage,
...
///
struct DefinedNaviItemView : View {
    private let NAVI_ICON_SIZE: CGFloat = 34
    private let NAVI_ICON_PADDING: CGFloat = 6
