...
/// - TODO: Debug
public struct DefinedTextField : View {
    /// 默认值 < 非强制外部变量 >
    ///
    ...
    public func setTextColorDefault(_ value: Color) -> DefinedTextField {
    ...
    ///
    /// - Parameter value: `Color` 。
    public func setTextColorActive(_ value: Color) -> DefinedTextField {
    ...
    ///
    /// - Parameter value: `Color` 。
    public func setBackgroundColorDefault(_ value: Color) -> DefinedTextField {
    ...
    ///
    /// - Parameter value: `Color` 。
    public func setBackgroundColorActive(_ value: Color) -> DefinedTextField {
    ...
    ///
    /// - Parameter value: `Color` 。
    public func setBorderColorDefault(_ value: Color) -> DefinedTextField {
    ...
    ///
    /// - Parameter value: `Color` 。
    public func setBorderColorActive(_ value: Color) -> DefinedTextField {
    ...
    public func setHorizontalExpandable(_ value: Bool) -> DefinedTextField {
    ...
    public func setVerticalExpandable(_ value: Bool) -> DefinedTextField {
    ...
    public func setBorderWidthDefault(_ value: CGFloat) -> DefinedTextField {
    ...
    ///
    /// - Parameter value: `CGFloat` 。
    public func setBorderWidthActive(_ value: CGFloat) -> DefinedTextField {
